...
export default async function DisclaimerPage() {
  const [navCategories, { mostRead, latest }] = await Promise.all([
    getNavCategories(),
    getHomepageData(),
  ])
  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      ...
      <SiteMainContainer className="space-y-6 py-10">
        ...
        <section className="mt-12 space-y-6 border-t border-zinc-200 pt-10">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-black text-zinc-900 uppercase">Tin mới nhất</h2>
            <Link href="/" className="text-sm font-bold text-rose-700 hover:underline">
              Xem tất cả
            </Link>
          </div>
